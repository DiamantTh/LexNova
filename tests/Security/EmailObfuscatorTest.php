...
$obfuscator = new EmailObfuscator(new SystemClock());
$payloads = [
...
foreach ($payloads as $payload) {
    $encoded = $obfuscator->obfuscate($payload);
...
$link = $obfuscator->mailto('alice+legal@example.org', 'example.org');
...
echo "Email obfuscator security test: OK\n";
